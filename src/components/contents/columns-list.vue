  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><router-link to="columns-list">栏目管理</router-link></li>
      </ol>
    </section>
...
<style scoped>
@import "../../../static/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css";
</style>